...
namespace gce
{
	...
	public:
		...
		RenderWindow(WString title, int32 width, int32 height, FullScreenMode mode = WINDOWED);
		...
		void Create(WString title, int32 width, int32 height, FullScreenMode mode = WINDOWED) override;
