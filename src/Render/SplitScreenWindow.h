...
namespace gce
{
	...
	public:
		...
		SplitScreenWindow(WString title, uint32 width, uint32 height, SplitScreenDisposition splitScreenForm, FullScreenMode mode = WINDOWED);
		...
		void Create(WString title, uint32 width, uint32 height, SplitScreenDisposition splitScreenForm, FullScreenMode mode = WINDOWED);
