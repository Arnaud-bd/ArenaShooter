...
namespace gce
{
	...
	Window::Window(WString const title, int32 const width, int32 const height, FullScreenMode const mode) :
	...
	void Window::Create(WString const title, int32 const width, int32 const height, FullScreenMode const mode)
	{
		m_height = height;
		m_width = width;
		m_initialFullScreenMode = mode;
	...
	bool Window::CreateWindowClass(WString const title, int32 const width, int32 const height)
	{
