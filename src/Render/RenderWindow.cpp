...
namespace gce
{
	...
	RenderWindow::RenderWindow(WString const title, int32 const width, int32 const height, FullScreenMode mode)
	{
		RenderWindow::Create(title, width, height, mode);
	}

	void RenderWindow::Create(WString const title, int32 const width, int32 const height, FullScreenMode mode)
	{
