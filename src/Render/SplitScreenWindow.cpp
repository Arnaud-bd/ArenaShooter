...
namespace gce
{
	SplitScreenWindow::SplitScreenWindow(WString title, uint32 width, uint32 height, SplitScreenDisposition splitScreenForm, FullScreenMode mode)
	{
	...
	void SplitScreenWindow::Create(WString title, uint32 width, uint32 height, SplitScreenDisposition splitScreenForm, FullScreenMode mode)
	{
