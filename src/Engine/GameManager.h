...
struct WindowParam
{
    WString title = L"Game Window"; // Do not work because of GameManager::HandleFPS
    uint16 width = 1280;
    uint16 height = 720;
...
public:
    ...
    static std::vector<GameObject*> GetAllGameObjectWithTag(EntityType type, Scene* scene);
    static GameObject* GetFirstGameObjectWithName(cstr name, Scene* scene);
