#ifndef TESTING_TEST_UI_IMAGE_H_INCLUDED
#define TESTING_TEST_UI_IMAGE_H_INCLUDED
...
BEGIN_TEST( UiImage )
    ...
    UiImage& uiImage = *crosshair.AddComponent<UiImage>();
    ...
    uiImage.btmBrush = new BitMapBrush("res/Textures/Crosshair.png");
